...
- **SSH Access:** ssh devlab@192.168.56.104
- **API Endpoint:** http://192.168.56.104:3000
...
http://localhost:8080           http://192.168.56.104:3000
                                        │
                                        ▼
                                   Database (SQLite)
```
...
```
http://192.168.56.104:3000/api/tasks
http://192.168.56.104:3000/api/tasks/stats
```
### Frontend (local)
```
http://localhost:8080
